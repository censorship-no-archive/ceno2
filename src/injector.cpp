...
static const boost::filesystem::path CENO2_PID_FILE = "pid";
...
int main(int argc, const char* argv[])
{
    ...
    if (exists(config.repo_root()/CENO2_PID_FILE)) {
        cerr << "Existing PID file " << config.repo_root()/CENO2_PID_FILE
    ...
    static const auto pid_file_path = config.repo_root()/CENO2_PID_FILE;
